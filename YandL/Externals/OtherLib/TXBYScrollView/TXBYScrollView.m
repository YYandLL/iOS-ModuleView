...
- (void)setUpScrollView {
    ...
    for (int i = 0; i < self.imgArr.count; i ++) {
        ...
        if (self.scrollImageType == ScrollImageCyber) {
            ...
            //            [imgView sd_setImageWithURL:[NSURL URLWithString:imgUrl] placeholderImage:[UIImage loadingImageWithSize]];
            imgView.contentMode = UIViewContentModeScaleAspectFit;
            [imgView sd_setImageWithURL:[NSURL URLWithString:imgUrl] placeholderImage:[UIImage loadingImageWithSize] completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
